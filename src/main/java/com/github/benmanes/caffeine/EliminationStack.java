 ...
 * <a href="http://citeseerx.ist.psu.edu/viewdoc/summary?doi=***REDACTED-IP***.8728">A Scalable Lock-free
 * Stack Algorithm</a>.
 * <p>
...
public final class EliminationStack<E> extends AbstractCollection<E> implements Serializable {
   ...
   * http://citeseerx.ist.psu.edu/viewdoc/summary?doi=***REDACTED-IP***.8728
   ...
   * http://citeseerx.ist.psu.edu/viewdoc/summary?doi=***REDACTED-IP***.6422
   * [4] A Scalable Elimination-based Exchange Channel
   * http://citeseerx.ist.psu.edu/viewdoc/summary?doi=***REDACTED-IP***.7396
   */
