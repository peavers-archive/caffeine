...
/**
 * Guava testlib map tests for {@link ConcurrentLinkedLazyQueue}.
 *
 * @author ***REDACTED-EMAIL*** (Ben Manes)
 */
public final class ConcurrentLinkedLazyQueueTests extends TestCase {
  ...
  private static TestSuite queueTest(boolean optimistic) {
    return QueueTestSuiteBuilder
        ...
        .named(ConcurrentLinkedLazyQueue.class.getSimpleName())
        .withFeatures(
