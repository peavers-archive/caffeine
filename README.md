...
```gradle
compile 'com.github.ben-manes.caffeine:caffeine:2.2.4'

// Optional extensions
compile 'com.github.ben-manes.caffeine:guava:2.2.4'
compile 'com.github.ben-manes.caffeine:jcache:2.2.4'
```
