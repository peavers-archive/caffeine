...
/**
 * A matcher that evaluates a {@link ConcurrentLinkedLazyQueue} to determine if it is in a valid
 * state.
 *
 * @author ***REDACTED-EMAIL*** (Ben Manes)
 */
public final class IsValidConcurrentLinkedLazyQueue<E>
    extends TypeSafeDiagnosingMatcher<ConcurrentLinkedLazyQueue<E>> {

  @Override
  public void describeTo(Description description) {
    description.appendText("ConcurrentLinkedLazyQueue");
  }

  @Override
  protected boolean matchesSafely(ConcurrentLinkedLazyQueue<E> queue, Description description) {
  ...
  void checkArena(ConcurrentLinkedLazyQueue<E> queue, DescriptionBuilder builder) {
  ...
  @Factory
  public static <E> IsValidConcurrentLinkedLazyQueue<E> validate() {
    return new IsValidConcurrentLinkedLazyQueue<E>();
  }
}
